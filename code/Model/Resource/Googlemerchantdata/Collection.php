 ...
 */
/**
 * Google Merchent Information collection resource model
 *
 * @category    Develo
 * @package     Develo_Googletrustedstores
...
class Develo_Googletrustedstores_Model_Resource_Googlemerchantdata_Collection
     ...
     * @author Ultimate Module Creator
     */
    protected function _toOptionArray($valueField='entity_id', $labelField='store_id', $additional=array()){
     ...
     * @author Ultimate Module Creator
     */
    protected function _toOptionHash($valueField='entity_id', $labelField='store_id'){
