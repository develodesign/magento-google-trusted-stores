...
class Develo_Googletrustedstores_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	const CONFIG_PATH_GOOGLE_BASE_SUBACCOUNT_ID     = "develo_googletrustedstores/merchant_data/google_base_subaccount_id";
	const CONFIG_PATH_GOOGLE_BASE_COUNTRY           = "develo_googletrustedstores/merchant_data/google_base_country";
	const CONFIG_PATH_GOOGLE_BASE_LANGUAGE          = "develo_googletrustedstores/merchant_data/google_base_language";
